...
struct CustomFile: View {
    ...
    //    @Binding var ShowErrorMessage:Bool = false
...
//
//                TextField(tfName ?? "Email", text: $data) { isActive in
//                    if isActive {
//                        showLabel = true
////                        borderColor = Color("ButtonColor")
//                        borderColor = (showError) ? Color(.gray) : Color(.red)
////                        CustomFile.LogIn?(email)
//                    }
//                    else {
//                        showLabel = false
////                        borderColor = showError ? Color(.gray) : Color(.red)
//                    }
//                }.onChange(of: email) {data in
//                    CustomFile.LogIn?(data, tfName!)
//                    borderColor = Color("ButtonColor")
//
//
//
...
//                    .overlay {
//                        RoundedRectangle(cornerRadius: 8, style: .continuous).stroke(borderColor, lineWidth: 2).frame(width: 300)
//                    }
//                if showLabel {
//                    HStack{
//                        Text(tfName ?? "Enter Details").background(.white)
//                        Spacer()
