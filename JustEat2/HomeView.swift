...
//  JustEat2
//
//  Created by Rapipay on 21/02/23.
//
...
//        .presentationDetents([.medium, .large])
    ...
    func sortRestraunt(sortType: Int, data: [HotelModel]) -> [HotelModel] {
        ...
        default:
            NetworkManager.shared.requestForApi(request: "https://retoolapi.dev/upVf9f/data", completionHandler: {
                data in
                guard let data = data as? [[String: Any]] else {return}
                let restraunts = data.map{HotelModel(data: $0)}
                temp = restraunts
            })
            return data
        }
...
//        HomeView(temp: [HotelModel(data: ["D": true,
//                                          "F": "2",
//                                          "G": "100",
//                                          "H": false,
...
//                                          ])],
//                        temp2: [FoodItems(data: ["D": "Burger",
//                                          "E": "100",
//                                        "G": "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.cityspidey.com%2Fnews%2F16703%2Fghaziabad-these-places-are-serving-the-best-burgers-in-the-town&psig=AOvVaw3TQtKiG0L894lrgRm87HoH&ust=1678262379117000&source=images&cd=vfe&ved=0CBAQjRxqFwoTCNil3tmsyf0CFQAAAAAdAAAAABAE",
//                                                                                                                                                                 
//                                         "col1": "\u{2b50}\u{fe0f}\u{2b50}\u{fe0f}",
//                                        "col2": "burger, is a sandwich consisting of fillings usually a patty of ground meat, typically placed inside a sliced bun or bread rol",
//                                        "col3": 732,
//                                    "id": 2,
//                                         "isUser": true])], searchData: "", isPressed: .constant(true))
//
//    }
//}
