...
//                    Text(items.category.joined(separator: ",")).font(.system(size: 20, weight: .regular))
                    HStack{
                        Text(restraunt.address! ).foregroundColor(Color.gray).font(.callout)
//                            .foregroundColor(Color.gray).font(.callout)
//                        Text("▼").foregroundColor(Color("DarkShade"))
//                        Image(systemName: "arrowtriangle.down.fill").foregroundColor(.pink).frame(width: 8, height: 6)
                    }
                    HStack{
...
//                            .overlay(RoundedRectangle(cornerRadius: 3).stroke(lineWidth: 2)).background(.green).border(.gray)
                ...
                .shadow(radius: 5)
//            .cornerRadius(20).overlay(RoundedRectangle(cornerRadius: 20)).stroke(Color.black.opacity(0.3),lineWidth: 2)
