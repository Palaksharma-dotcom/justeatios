...
//  JustEat2
//
//  Created by Rapipay on 03/03/23.
//

import SwiftUI

struct FilterView: View {
//    @State var vegResult = [HotelModel]
...
//                            .foregroundColor(Color.red)
                ...
                HStack
                {
                    ...
                    Text("noodles").padding()
                     .foregroundColor(selectCategory[6] ? Color.blue : Color.red)
                        .overlay(RoundedRectangle(cornerRadius: 10, style: .continuous).stroke(selectCategory[6] ? Color.blue : Color.black,lineWidth: 1))
                        .onTapGesture{
                            selectCategory[6].toggle()
                    
                        }
                    
                    
                    
                    Text("ice cream").padding().foregroundColor(selectCategory[7] ? Color.blue : Color.red).lineLimit(1)
                    //                            .padding(15)
                        .overlay(RoundedRectangle(cornerRadius: 10).stroke(selectCategory[7] ? Color.blue : Color(.black),lineWidth: 1))
                        .onTapGesture{
                            selectCategory[7].toggle()
                            
                        }
                    Text("sandwich").padding().lineLimit(1)
                    //                            .foregroundColor(Color.red)
                        .foregroundColor(selectCategory[8] ? Color.blue : Color.red)
                        .overlay(RoundedRectangle(cornerRadius: 10, style: .continuous).stroke(selectCategory[8] ? Color.blue : Color.black,lineWidth: 1))
                        .onTapGesture{
                            selectCategory[8].toggle()
                        }
                }
                ...
                HStack{
                    ...
                    Text("biryani").padding()
                    //                            .lineLimit(1)
//                            .foregroundColor(Color.red)
                        .foregroundColor(selectCategory[9] ? Color.blue : Color.red)
                        .overlay(RoundedRectangle(cornerRadius: 10, style: .continuous).stroke(selectCategory[9] ? Color.blue : Color.black,lineWidth: 1))
                        .onTapGesture{
                            selectCategory[9].toggle()
                    
                        }
                    
                    
                    
                    Text("cake").padding().foregroundColor(selectCategory[10] ? Color.blue : Color.red).lineLimit(1)
                    //                            .padding(15)
                        .overlay(RoundedRectangle(cornerRadius: 10).stroke(selectCategory[10] ? Color.blue : Color(.black),lineWidth: 1))
                        .onTapGesture{
                            selectCategory[10].toggle()
                            
                        }
                    Text("shake").padding().lineLimit(1)
                   
                        .foregroundColor(selectCategory[11] ? Color.blue : Color.red)
                        .overlay(RoundedRectangle(cornerRadius: 10, style: .continuous).stroke(selectCategory[11] ? Color.blue : Color.black,lineWidth: 1))
                        .onTapGesture{
                            selectCategory[11].toggle()
                        }
                }
